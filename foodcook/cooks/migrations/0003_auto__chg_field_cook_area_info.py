...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cooks_cook', 'area_info', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'cooks.cook': {
            ...
            'area_info': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),

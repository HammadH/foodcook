...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cook.image'
        db.alter_column(u'cooks_cook', 'image', self.gf(u'sorl.thumbnail.fields.ImageField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Cook.image'
        db.alter_column(u'cooks_cook', 'image', self.gf(u'sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'cooks.cook': {
            ...
            'cook_type': ('django.db.models.fields.related.ForeignKey', [], {'default': "'Unspecified'", 'to': u"orm['cooks.CookType']", 'null': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': (u'sorl.thumbnail.fields.ImageField', [], {'default': "'/home/dubizzle/projects/foodcook/foodcook/foodcook/media/default/profile1.png'", 'max_length': '1000', 'blank': 'True'}),
            'intro': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'lunch': ('django.db.models.fields.BooleanField', [], {}),
            'max_price': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'min_price': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
